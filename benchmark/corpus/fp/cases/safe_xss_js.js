// Safe DOM output. Nothing here should be reported.
//
...
// the DOM validates against a fixed set of four values. Before ZS-JS-047 was
...
function renderBanner(req, el) {
  const position = req.query.placement;
  el.insertAdjacentHTML(position, '<b>Welcome back</b>');
}

// Attacker-controlled text, inserted as text. insertAdjacentText escapes by
// construction, so this is the fix ZS-JS-047 recommends, not a finding.
