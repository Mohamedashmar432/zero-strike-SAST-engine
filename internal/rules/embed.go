...
// cannot absorb.
//
//go:embed data/python/*.yaml data/js/*.yaml data/ts/*.yaml data/csharp/*.yaml data/go/*.yaml data/php/*.yaml
...
var RuleDirs = []string{"data/python", "data/js", "data/ts", "data/csharp", "data/go", "data/php"}
